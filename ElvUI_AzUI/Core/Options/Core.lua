	...
	modules = {
		...
		args = {
			info = {
				order = 1,
				type = "description",
				name = L["Here you find the options for all the different |cffffffffAz|r|cffff8000UI|r modules."],
			},
		},
	},
	misc = {
	...
	E.Options.args.mui = {
		...
		args = {
			name = {
				order = 1,
				type = "header",
				name = MER.Title..F.cOption(MER.Version, 'blue')..L["by Äz (|cFF00c0faNA-Dreamscythe|r)"],
			},
			logo = {
				order = 2,
				type = "description",
			...
			discordButton = {
				order = 5,
				type = "execute",
				name = L["|cffffffffAz|r|cffff7d0aUI|r Discord"],
				customWidth = 140,
				func = function() E:StaticPopup_Show("AzUI_CREDITS", nil, nil, "https://discord.gg/28We6esE9v") end,
			},
		},
	}
