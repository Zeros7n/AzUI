		...
		support = {
			...
			args = {
				tukui = {
					...
					type = "execute",
					name = L["Tukui"],
					func = function() E:StaticPopup_Show("AzUI_CREDITS", nil, nil, "https://www.tukui.org/addons.php?id=1") end,
					},
				curse = {
					order = 2,
					type = "execute",
					name = L["CurseForge"],
					func = function() E:StaticPopup_Show("AzUI_CREDITS", nil, nil, "https://www.curseforge.com/wow/addons/Az-ui") end,
				},
				development = {
					order = 3,
					type = 'execute',
					...
					func = function() E:StaticPopup_Show("AzUI_CREDITS", nil, nil, "https://github.com/Az/ElvUI_AzUI/archive/refs/heads/development.zip") end,
				},
				spacer = {
					order = 4,
					type = 'description',
				...
				discord = {
					...
					func = function() E:StaticPopup_Show("AzUI_CREDITS", nil, nil, "https://discord.gg/xFWcfgE") end,
				},
				git = {
					order = 6,
					type = "execute",
					...
					func = function() E:StaticPopup_Show("AzUI_CREDITS", nil, nil, "https://github.com/Az/ElvUI_AzUI/issues") end,
				},
				spacer1 = {
					order = 7,
					type = 'description',
...
options.reset = {
	...
	args = {
		...
		autoButtons = {
			...
			name = L["AutoButtons"],
			func = function()
				E:StaticPopup_Show("AzUI_RESET_MODULE", L["AutoButtons"], nil, function()
		...
		locPanel = {
			...
			func = function()
				E:StaticPopup_Show("AzUI_RESET_MODULE", L["Location Panel"], nil, function()
		...
		microBar = {
			...
			name = L["Micro Bar"],
			func = function()
				E:StaticPopup_Show("AzUI_RESET_MODULE", L["Micro Bar"], nil, function()
		...
		cooldownFlash = {
			...
			func = function()
				E:StaticPopup_Show("AzUI_RESET_MODULE", L["Cooldown Flash"], nil, function()
		...
		raidmarkers = {
			...
			name = L["Raid Markers"],
			func = function()
				E:StaticPopup_Show("AzUI_RESET_MODULE", L["Raid Markers"], nil, function()
		...
		smb = {
			...
			func = function()
				E:StaticPopup_Show("AzUI_RESET_MODULE", L["Minimap Buttons"], nil, function()
		...
		eventTracker = {
			...
			func = function()
				E:StaticPopup_Show("AzUI_RESET_MODULE", L["Event Tracker"], nil, function()
		...
		bigWigsSkin = {
			...
			name = L["BigWigs Skin"],
			func = function()
				E:StaticPopup_Show("AzUI_RESET_MODULE", L["BigWigs Skin"], nil, function()
		...
		chatBar = {
			...
			name = L["Chat Bar"],
			func = function()
				E:StaticPopup_Show("AzUI_RESET_MODULE", L["Chat Bar"], nil, function()
		...
		misc = {
			...
			args = {
				general = {
					...
					name = L["General"],
					func = function()
						E:StaticPopup_Show("AzUI_RESET_MODULE", L["General"], nil, function()
		...
		resetAllModules = {
			...
			func = function()
				E:StaticPopup_Show("AzUI_RESET_ALL_MODULES")
			end,
			width = "full"
		},
	},
