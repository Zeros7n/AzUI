...
E.PopupDialogs["WINDTOOLS_MER_INCOMPATIBLE"] = {
	text = L["You got |cff00c0faElvUI_Windtools|r and |cffff7d0aAzUI|r both enabled at the same time. Please select an addon to disable."],
	OnAccept = function() DisableAddOn("ElvUI_WindTools"); ReloadUI() end,
	OnCancel = function() DisableAddOn("ElvUI_AzUI"); ReloadUI() end,
...
E.PopupDialogs["LIVVEN_MER_INCOMPATIBLE"] = {
	text = L["You got |cff9482c9ElvUI_LivvenUI|r and |cffff7d0aAzUI|r both enabled at the same time. Please select an addon to disable."],
...
E.PopupDialogs.AzUI_RESET_MODULE = {
...
E.PopupDialogs.AzUI_RESET_ALL_MODULES = {
...
E.PopupDialogs.AzUI_INVALIDPOWER = {
