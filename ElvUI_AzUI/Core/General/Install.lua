...
local function SetupChat()
	...
	E.db["chat"]["keywords"] = "%MYNAME%, ElvUI, AzUI"
...
function MER:SetupNamePlates()
	...
	--]]----------------------------------
	if E.Retail then
		for _, filterName in pairs({'AzUI_Neutral'}) do
			E.global["nameplates"]["filters"][filterName] = {}
			E.NamePlates:StyleFilterCopyDefaults(E.global["nameplates"]["filters"][filterName])
			E.db["nameplates"]["filters"][filterName] = { triggers = { enable = true } }
		end

		E.global["nameplates"]["filters"]["AzUI_Neutral"]["actions"]["nameOnly"] = true
		E.global["nameplates"]["filters"]["AzUI_Neutral"]["triggers"]["notTarget"] = true
		E.global["nameplates"]["filters"]["AzUI_Neutral"]["triggers"]["outOfCombat"] = true
		E.global["nameplates"]["filters"]["AzUI_Neutral"]["triggers"]["outOfVehicle"] = true
		E.global["nameplates"]["filters"]["AzUI_Neutral"]["triggers"]["reactionType"]["enable"] = true
		E.global["nameplates"]["filters"]["AzUI_Neutral"]["triggers"]["reactionType"]["neutral"] = true
		E.global["nameplates"]["filters"]["AzUI_Neutral"]["triggers"]["reactionType"]["reputation"] = true
	end
...
local addonNames = {}
local profilesFailed = format("|cff00c0fa%s |r", L["AzUI didn't find any supported addons for profile creation"])
...
function MER:SetupAddOns()
	...
	if checkTable(addonNames) ~= nil then
		local profileString = format("|cfffff400%s |r", L["AzUI successfully created and applied profile(s) for:"].."\n")
...
MER.installTable = {
	...
	["Pages"] = {
		[1] = function()
			PluginInstallFrame.SubTitle:SetFormattedText(L["Welcome to AzUI |cff00c0faVersion|r %s, for ElvUI %s."], MER.Version, E.version)
			PluginInstallFrame.Desc1:SetText(L["By pressing the Continue button, AzUI will be applied in your current ElvUI installation.\r\r|cffff8000 TIP: It would be nice if you apply the changes in a new profile, just in case you don't like the result.|r"])
		...
		[5] = function()
			...
			PluginInstallFrame.Desc1:SetText(L["This part of the installation process will fill AzUI datatexts.\r|cffff8000This doesn't touch ElvUI datatexts|r"])
		...
		[10] = function()
			...
			PluginInstallFrame.Option1:Show()
			PluginInstallFrame.Option1:SetScript("OnClick", function() E:StaticPopup_Show("AzUI_CREDITS", nil, nil, "https://discord.gg/28We6esE9v") end)

			PluginInstallFrame.Option1:SetText(L["|cffff7d0aAzUI|r Discord"])
