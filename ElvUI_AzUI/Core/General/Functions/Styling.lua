...
local function Styling(f, useStripes, useShadow)
	...
	if not(useStripes) then
		...
		stripes:SetTexture([[Interface\AddOns\ElvUI_AzUI\Core\Media\Textures\stripes]], true, true)
	...
	if not(useShadow) then
		...
		mshadow:Width(33)
		mshadow:Height(33)
		mshadow:SetTexture([[Interface\AddOns\ElvUI_AzUI\Core\Media\Textures\Overlay]])
