...
L["Modules"] = true
L["Media"] = true
L["MER_DESC"] = [=[|cffffffffAz|r|cffff7d0aUI|r is an extension of ElvUI. It adds:
...
L["%players% (%bnet%) has come online."] = "%players% (%bnet%) 님이 접속했습니다."
L["%players% (%bnet%) has gone offline."] = "%players% (%bnet%) 님이 접속을 종료했습니다."
...
-- Staticpopup
L["MSG_MER_ELV_OUTDATED"] = "Your version of ElvUI is older than recommended to use with |cffff7d0aAzUI|r. Your version is |cff00c0fa%.2f|r (recommended is |cff00c0fa%.2f|r). AzUI isn't loaded. Please update your ElvUI."
...
L["You can disable/enable compatibility check via the option in the bottom of [AzUI]-[Information]."] = "[AzUI]-[정보] 하단의 옵션을 통해 호환성 검사를 비활성화/활성화할 수 있습니다."
L["Complete"] = "완료"
...
-- Abbreviate
L["[ABBR] Algeth'ar Academy"] = "대학"
L["[ABBR] Announcement"] = "퀘스트 알림"
L["[ABBR] Back"] = "등"
L["[ABBR] Chest"] = "가슴"
L["[ABBR] Community"] = "C"
L["[ABBR] Court of Stars"] = "별궁"
...
L["[ABBR] Roll"] = "RL"
L["[ABBR] Ruby Life Pools"] = "루비"
L["[ABBR] Say"] = "S"
L["[ABBR] Scenario"] = "시나리오"
L["[ABBR] Shadowmoon Burial Grounds"] = "어둠달"
L["[ABBR] Shoulders"] = "어깨"
L["[ABBR] Temple of the Jade Serpent"] = "옥룡사"
L["[ABBR] The Azure Vault"] = "하늘빛"
L["[ABBR] The Nokhud Offensive"] = "노쿠드"
