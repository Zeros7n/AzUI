...
L["Modules"] = true
L["Media"] = true
L["MER_DESC"] = [=[|cffffffffAz|r|cffff7d0aUI|r est une extension d'ElvUI. Cela ajoute:
...
L["{rt1} %player% is handing out %spell%, go and get one! {rt1}"] = "{rt1} %player% propose des %spell%, venez en prendre un ! {rt1}"
