...
L["by Az (|cFF00c0faEU-Shattrath|r)"] = true
L["AFK"] = "离开"
...
L["Modules"] = true
L["Media"] = true
L["MER_DESC"] = [=[|cffffffffAz|r|cffff7d0aUI|r 是ElvUI的扩展. 它增加了:
...
-- Modules
L["Here you find the options for all the different |cffffffffAz|r|cffff8000UI|r modules."] = "你能在这里找到所有不同的选项 |cffffffffAz|r|cffff8000UI|r 模块."
...
-- FlightPoint
L["Flight Point"] = "飞行点"
L["Enable/Disable the AzUI Flight Points on the FlightMap."] = "在飞行地图上启用/禁用AzUI飞行点."
...
L["{rt1} %player% cast %spell%, today's special is Anchovy Pie! {rt1}"] = "{rt1} %player%使用了%spell%, 各位快来领面包哦! {rt1}"
L["{rt1} %player% is casting %spell%, please assist! {rt1}"] = "{rt1} %player%正在进行 %spell%, 请配合点门哦! {rt1}"
...
L["Adds my styling to the Unitframes if you use transparent health."] = "当你使用透明头像时，添加Az风格"
...
-- Raid Manager
L["Raid Manager"] = "团队管理"
L["This will disable the ElvUI Raid Control and replace it with my own."] = "这将禁用ElvUI的团队管理，替换为Az的"
...
-- Install
L["Welcome"] = "欢迎"
L["|cffff7d0aAzUI|r Installation"] = "|cffff7d0aAzUI|r安装"
L["AzUI Set"] = "AzUI设置"
L["AzUI didn't find any supported addons for profile creation"] = "AzUI没有找到任何支持的插件用于配置文件创建."
L["AzUI successfully created and applied profile(s) for:"] = "AzUI成功创建并应用了个人配置为:"
L["Chat Set"] = "聊天框设置"
L["ActionBars"] = "动作条"
...
L["Welcome to AzUI |cff00c0faVersion|r %s, for ElvUI %s."] = "欢迎来到AzUI |cff00c0faVersion|r %s, 适用于ElvUI %s."
L["By pressing the Continue button, AzUI will be applied in your current ElvUI installation.\r\r|cffff8000 TIP: It would be nice if you apply the changes in a new profile, just in case you don't like the result.|r"] = "按下继续按钮，AzUI将应用于您当前的ElvUI安装.\r\r|cffff8000 小窍门: 防止你不喜欢这个结果，你应该在新的配置文件中应用这个更改.|r"
...
L["This part of the installation process will fill AzUI datatexts.\r|cffff8000This doesn't touch ElvUI datatexts|r"] = "这部分安装过程将填充AzUI数据文本.\r|cffff8000这不会触及ElvUI数据文本|r"
...
-- Staticpopup
L["MSG_MER_ELV_OUTDATED"] = "您的ElvUI版本比推荐使用|cffff7d0aAzUI|r的版本旧. 你的版本是 |cff00c0fa%.2f|r (推荐版本 |cff00c0fa%.2f|r). AzUI未加载. 请更新你的ElvUI."
...
L["You can disable/enable compatibility check via the option in the bottom of [AzUI]-[Information]."] = "你可以通过设定位于 [AzUI]-[信息] 底部的选项来启用/停用兼容性检查."
L["Complete"] = "完成"
