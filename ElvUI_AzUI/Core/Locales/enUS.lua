...
L["by Äz (|cFF00c0faNA-Dreamscythe|r)"] = true
L["AFK"] = "Away"
L["Enable/Disable the AzUI AFK Screen. Disabled if BenikUI is loaded"] = true
...
-- Modules
L["Here you find the options for all the different |cffffffffAz|r|cffff8000UI|r modules."] = true
...
-- FlightPoint
L["Flight Point"] = true
L["Enable/Disable the AzUI Flight Points on the FlightMap."] = true
...
-- Sales Ledger
L["Sales Ledger"] = "AzUI Sales"
L["Sales Ledger is disabled. Enable it in AzUI > Modules and reload."] = "AzUI Sales is disabled. Enable it in AzUI > Modules and reload."
L["Sales Ledger Alert"] = "AzUI Sales Alert"
L["Characters"] = true
L["Character"] = true
L["Gold"] = true
L["Delta"] = true
...
L["Net"] = true
L["Earned"] = true
L["Earned by Date"] = true
L["Spent"] = true
L["Profit"] = true
L["Details"] = true
L["Default Scope"] = true
L["Rolling Days"] = true
L["Track Unclassified"] = true
L["Default View"] = true
L["Notifications"] = true
L["Chat Message"] = true
L["Fade Alert"] = true
L["Combine Window"] = true
L["Purge"] = true
L["Keep Days"] = true
L["Purge Mode"] = true
L["Run on Login"] = true
...
L["Loot"] = true
L["Vendor Sale"] = true
L["Vendor Purchase"] = true
L["Auction Sale"] = true
L["Auction Purchase"] = true
L["Auction Expired"] = true
L["Auction Canceled"] = true
L["Auction Deposit"] = true
L["Auction Cut"] = true
L["Mail"] = true
L["Trade"] = true
L["COD"] = true
...
L["Total"] = true
L["%d Items Sold"] = true
L["Auction Sold: %s x%d for %s (%s each), net %s"] = true
L["Buyer"] = true
L["DataText"] = true
...
L["{rt1} %player% is handing out cookies, go and get one! {rt1}"] = true
L["{rt1} %player% opened %spell%! {rt1}"] = true
L["{rt1} %player% puts %spell% {rt1}"] = true
L["{rt1} %player% used %spell% {rt1}"] = true
L["{rt1} %player%'s %pet_role% %pet% failed on taunting %target%! {rt1}"] = true
L["{rt1} %player%'s %pet_role% %pet% taunted %target% successfully! {rt1}"] = true
...
-- Install
L["Welcome"] = true
L["|cffff7d0aAzUI|r Installation"] = true
L["AzUI Set"] = true
L["AzUI didn't find any supported addons for profile creation"] = true
L["AzUI successfully created and applied profile(s) for:"] = true
L["Chat Set"] = true
L["ActionBars"] = true
...
L["Welcome to AzUI |cff00c0faVersion|r %s, for ElvUI %s."] = true
L["By pressing the Continue button, AzUI will be applied in your current ElvUI installation.\r\r|cffff8000 TIP: It would be nice if you apply the changes in a new profile, just in case you don't like the result.|r"] = true
...
L["This part of the installation process will fill AzUI datatexts.\r|cffff8000This doesn't touch ElvUI datatexts|r"] = true
...
-- Staticpopup
L["MSG_MER_ELV_OUTDATED"] = "Your version of ElvUI is older than recommended to use with |cffff7d0aAzUI|r. Your version is |cff00c0fa%.2f|r (recommended is |cff00c0fa%.2f|r). Please update your ElvUI to avoid errors."
...
L["You can disable/enable compatibility check via the option in the bottom of [AzUI]-[Information]."] = true
L["Complete"] = true
