...
-- General Options
L["Plugin for |cffff7d0aElvUI|r by\nAz."] = "Plugin für |cffff7d0aElvUI|r von\nAz."
L["by Az (|cFF00c0faEU-Shattrath|r)"] = "von Az (|cFF00c0faEU-Shattrath|r)"
L["AFK"] = "AFK"
...
L["Modules"] = "Module"
L["Media"] = "Medien"
L["MER_DESC"] = [=[|cffffffffAz|r|cffff7d0aUI|r ist eine Erweiterung für ElvUI. Sie ergänzt:
...
|cFF00c0faHinweis:|r |cffff7d0aAzUI|r ist mit den meisten anderen ElvUI Plugins kompatibel.
...
-- Modules
L["Here you find the options for all the different |cffffffffAz|r|cffff8000UI|r modules."] = "Hier findest du alle Optionen zu den verschiedenen |cffffffffAz|r|cffff8000UI|r Modulen."
...
L["Enable/Disable the AzUI Flight Points on the FlightMap."] = "Aktivert/Deaktiviert die AzUI Flugpunkte auf der Flugkarte."
...
L["{rt1} %player% cast %spell%, today's special is Anchovy Pie! {rt1}"] = "{rt1} %player% zaubert %spell%, dass heutige Spezial ist Sardellenkuchen! {rt1}"
L["{rt1} %player% is casting %spell%, please assist! {rt1}"] = "{rt1} %player% zaubert %spell%, bitte helfen! {rt1}"
L["{rt1} %player% is handing out %spell%, go and get one! {rt1}"] = "{rt1} %player% verteilt %spell%, geh und hole Dir welche! {rt1}"
...
L["|cffff7d0aAzUI|r Installation"] = true -- no need to translate
L["AzUI Set"] = "AzUI gesetzt"
L["AzUI didn't find any supported addons for profile creation"] = "AzUI konnte keine Addonprofile finden, die unterstützt werden."
L["AzUI successfully created and applied profile(s) for:"] = "AzUI hat erfolgreich ein Profil erstellt und angewandt für:"
...
L["This part of the installation process will fill AzUI datatexts.\r|cffff8000This doesn't touch ElvUI datatexts|r"] = "Diese Einstellungen füllt die Infotexte.\r|cffff8000Die Einstellungen der Infotexte von ElvUI wird nicht verändert.|r"
...
L["This part of the installation process will change your NamePlates."] = "Dieser Teil der Installation ändert die Namensplaketten."
...
L["Please click the button below to setup your NamePlates."] = "Bitte drücke die Taste unten, um die Namensplaketten einzustellen."
...
-- Staticpopup
L["MSG_MER_ELV_OUTDATED"] = "Deine Version von ElvUI ist älter als die empfohlene Version um |cffff7d0aAzUI|r zu nutzen. Deine Version ist |cff00c0fa%.2f|r (empfohlen ist |cff00c0fa%.2f|r). Bitte aktualisiere dein ElvUI um Fehler zu vermeiden!"
...
L["decor."] = "Dekor"
L["AzUI Button Style"] = "AzUI Tastenstil"
L["Creates decorative stripes on Ingame Buttons (only active with MUI Style)"] = "Fügt dekorative Streifen den Ingame-Buttons hinzu. (Nur aktiv mit AzUI Stil)"
...
L["You can disable/enable compatibility check via the option in the bottom of [AzUI]-[Information]."] = "Du kannst die Kompatibilitätsprüfung über die Option unten in [AzUI]-[Informationen] deaktivieren/aktivieren."
L["Complete"] = "Komplett"
