...
MER.ClassIcons = {
	["WARRIOR"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/Warrior",
	["PALADIN"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/Paladin",
	["HUNTER"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/Hunter",
	["ROGUE"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/Rogue",
	["PRIEST"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/Priest",
	["DEATHKNIGHT"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/DeathKnight",
	["SHAMAN"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/Shaman",
	["MAGE"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/Mage",
	["WARLOCK"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/Warlock",
	["MONK"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/Monk",
	["DRUID"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/Druid",
	["DEMONHUNTER"] = "Interface/AddOns/ElvUI_AzUI/Core/Media/Icons/ClassIcon/DemonHunter",
...
LSM:Register("font","PrototypeRU", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\PROTOTYPE_RU.TTF]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font","Visitor1", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\visitor1.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font","Visitor2", [[Interface\AddOns\ElvUI_AzUI\\Core\Media\Fonts\visitor2.ttf]])
LSM:Register("font","Tukui", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\uf_font.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font","ArialN", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\ARIALN.ttf]])
LSM:Register("font","Default", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\default.ttf]])
LSM:Register("font","Roboto-Black", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Roboto-Black.ttf]])
LSM:Register("font","Roboto-Bold", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Roboto-Bold.ttf]])
LSM:Register("font","Roboto-Medium", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Roboto-Medium.ttf]])
LSM:Register("font","Roboto-Regular", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Roboto-Regular.ttf]])
LSM:Register("font","GoodDogCool", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\gdcool.ttf]])
LSM:Register("font","BadaBoom", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\BADABB__.ttf]])
LSM:Register("font","Gothic-Bold", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\CenturyGothicBold.ttf]])
LSM:Register("font","Gotham Narrow Black", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\GothamNarrow-Black.ttf]])
LSM:Register("font","Gotham Narrow Ultra", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\GothamNarrow-Ultra.otf]])
LSM:Register("font","Montserrat-Black", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Montserrat-Black.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font","Montserrat-Bold", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Montserrat-Bold.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font","Montserrat-ExtraBold", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Montserrat-ExtraBold.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font","Montserrat-ExtraLight", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Montserrat-ExtraLight.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font","Montserrat-Light", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Montserrat-Light.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font","Montserrat-Medium", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Montserrat-Medium.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font","Montserrat-Regular", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Montserrat-Regular.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font","Montserrat-SemiBold", [[Interface\AddOns\ElvUI_AzUI\Core\Media\Fonts\Montserrat-SemiBold.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)

-- Backgrounds
-- Border

-- Statusbars
LSM:Register("statusbar","AzBlank", [[Interface\BUTTONS\WHITE8X8.blp]])
LSM:Register("statusbar","AzUI1", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\mUI2.tga]])
LSM:Register("statusbar","AzUI2", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\mUI3.tga]])
LSM:Register("statusbar","AzUI4", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\mUI4.tga]])
LSM:Register("statusbar","AzOnePixel", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\OnePixel.tga]])
LSM:Register("statusbar","AzMelli", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\Melli.tga]])
LSM:Register("statusbar","AzMelliDark", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\MelliDark.tga]])
LSM:Register("statusbar","AzEmpty", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\Empty.tga]])
LSM:Register("statusbar","AznormTex", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\normTex.tga]])
LSM:Register("statusbar","AzDefault", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\default.tga]])
LSM:Register("statusbar","AzLight", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\Light.tga]])
LSM:Register("statusbar","AzFeint", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\AzFeint.tga]])
LSM:Register("statusbar","AzBorder", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\Border.tga]])
LSM:Register("statusbar","Gradient", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\gradient1.tga]])
LSM:Register("statusbar","MER_NormTex", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\MERNormTex.tga]])
LSM:Register("statusbar","Lyn1", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\lyn1.tga]])
LSM:Register("statusbar","Skullflower", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\Skullflower.tga]])
LSM:Register("statusbar","SkullflowerLight", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\SkullflowerLight.tga]])
LSM:Register("statusbar","Duffed", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\Duffed.tga]])
LSM:Register("statusbar","RenAscension", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\RenAscension.tga]])
LSM:Register("statusbar","RenAscensionL", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\RenAscensionL.tga]])
LSM:Register("statusbar","4Pixel", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\Line4pixel.tga]])
LSM:Register("statusbar","Asphyxia", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\AsphyxiaNorm.tga]])
LSM:Register("statusbar","MER_Stripes", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\MER_Stripes.tga]])
LSM:Register("statusbar","Simpy19", [[Interface\AddOns\ElvUI_AzUI\Core\Media\StatusBars\simpy_tex19.tga]])

-- Sounds
LSM:Register("sound","warning",[[Interface\AddOns\ElvUI_AzUI\Core\Media\Sounds\warning.ogg]])
LSM:Register("sound","OnePlus Light",[[Interface\AddOns\ElvUI_AzUI\Core\Media\Sounds\OnePlusLight.ogg]])

-- Custom Textures
E.media.roleIcons = [[Interface\AddOns\ElvUI_AzUI\Core\Media\Textures\UI-LFG-ICON-ROLES]]
E.media.checked = [[Interface\AddOns\ElvUI_AzUI\Core\Media\Textures\checked]]
