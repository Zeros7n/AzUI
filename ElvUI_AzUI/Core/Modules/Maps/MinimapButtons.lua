...
function module:CreateFrames()
	...
	E:CreateMover(self.barAnchor, "MER_MinimapButtonBarAnchor", L["Minimap Buttons Bar"], nil, nil, nil, "ALL,SOLO,AzUI", function() return E.db.mui.smb.enable end, "mui,modules,maps")
end
