...
SlashCmdList.TESTNOTIFICATION = function(b)
	module:DisplayToast(F.cOption("AzUI:", 'gradient'), L["This is an example of a notification."], testCallback, b == "true" and "INTERFACE\\ICONS\\SPELL_FROST_ARCTICWINDS" or nil, .08, .92, .08, .92)
end
...
function module:Initialize()
	...
	E:CreateMover(anchorFrame, "MER_NotificationMover", L["Notification Mover"], nil, nil, nil, "ALL,SOLO,AzUI", nil, 'mui,modules,Notification')
