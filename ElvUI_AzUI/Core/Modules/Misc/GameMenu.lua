...
local logo = "Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\AzUI_logo_Large.tga"
...
function module:GameMenu()
	...
	if not GameMenuFrame.MUItopPanel then
		...
		topPanel.factionLogo:SetTexture("Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\ClassBanner\\CLASS-"..E.myclass)
	end
