...
function module:CreateChatButtons()
	...
	ChatButton.tex:SetTexture("Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\chatButton")
...
function module:AddCustomEmojis()
	--Custom Emojis
	local t = "|TInterface\\AddOns\\ElvUI_AzUI\\media\\textures\\chatEmojis\\%s:16:16|t"
