...
--ToDO: WoW10
if _G.UseContainerItem then -- Check if the global function UseContainerItem exists
...
function module:Initialize()
	...
	E:CreateMover(DCP, "MER_CooldownFlashMover", L["CooldownFlashMover"], true, nil, nil, 'ALL,SOLO,AzUI', nil, 'mui,modules,cooldownFlash')
end
