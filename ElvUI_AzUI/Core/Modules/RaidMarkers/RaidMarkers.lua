...
function module:CreateBar()
	...
	E:CreateMover(self.barAnchor, "MER_RaidMarkersBarAnchor", L["Raid Markers Bar"], nil, nil, nil, "ALL,PARTY,RAID,AzUI", function() return E.db.mui.raidmarkers.enable end, "mui,modules,raidmarkers")
end
