...
local function LoadSkin()
	...
	_G.FriendsFrameIcon:SetTexture([[Interface\AddOns\ElvUI_AzUI\Core\Media\Textures\Bnet]])
	_G.FriendsFrameIcon:SetSize(36, 36)

	hooksecurefunc(_G.FriendsFrameIcon, "SetTexture", function(self, texture)
		if texture ~= [[Interface\AddOns\ElvUI_AzUI\Core\Media\Textures\Bnet]] then
			self:SetTexture([[Interface\AddOns\ElvUI_AzUI\Core\Media\Textures\Bnet]])
		end
	end)
