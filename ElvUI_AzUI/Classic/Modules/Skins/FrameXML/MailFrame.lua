...
local function LoadSkin()
	...
	_G.MiniMapMailIcon:SetTexture("Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\Mail")
	...
	MiniMapMailFrame:SetScript("OnShow", function()
		if not MiniMapMailFrame.highlight then
			...
			MiniMapMailFrame.highlight.tex:SetTexture("Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\Mail")
