...
function RM:ChangeShape()
	...
	local texturePath = format("Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\MinimapMasks\\%d.tga", fileID)
...
function RM:Initialize()
	self.db = E.db.mui.maps.rectangleMinimap
	if not self.db or not self.db.enable or not MM.Initialized then
		return
	end
