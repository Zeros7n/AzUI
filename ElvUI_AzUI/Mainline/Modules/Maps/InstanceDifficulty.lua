...
function module:ConstructFrame()
	...
	E:CreateMover(frame, "MER_InstanceDifficultyFrameMover", L["Instance Difficulty"], nil, nil, nil, "ALL,AzUI", function() return E.db.mui.maps.minimap.difficulty.enable end, "mui,modules,maps")
