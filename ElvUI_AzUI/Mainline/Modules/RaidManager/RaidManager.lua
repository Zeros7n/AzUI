...
function module:CreateRaidManager()
	...
	RaidManagerFrame.Close.tex:SetTexture("Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\Icons\\Exit")
...
function module:CreateRaidInfo()
	...
	E:CreateMover(header, "MER_RaidManager", L["Raid Manager"], nil, nil, nil, "ALL,SOLO,PARTY,RAID,AzUI", nil, 'mui,misc')
	...
	for i = 1, 3 do
		...
		role[i]:Size(15, 15)
		role[i]:SetTexture("Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\LFGROLE")
