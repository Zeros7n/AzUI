...
local function LoadSkin()
	...
	Tab:SetNormalTexture("Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\clique") --override the Texture to take account for Simpy's Icon pack
	Tab:GetNormalTexture():SetTexCoord(unpack(E.TexCoords))
	Tab:GetNormalTexture():SetInside()

	Tab:SetPushedTexture("Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\clique") -- override the Texture to take account for Simpy's Icon pack
	Tab:GetPushedTexture():SetTexCoord(unpack(E.TexCoords))
	Tab:GetPushedTexture():SetInside()

	Tab:SetHighlightTexture("Interface\\AddOns\\ElvUI_AzUI\\Core\\Media\\Textures\\clique") -- override the Texture to take account for Simpy's Icon pack
